defmodule RBMQ.Connection.HelperTest do
  ...
  defmodule SampleConfigurator do
    use Confex, otp_app: :rbmq19
  end

  alias RBMQ.Connection.HelperTest.SampleConfigurator

  setup do
    Application.delete_env(:rbmq19, SampleConfigurator)
  end

  test "invalid host raise exception" do
    Application.put_env(:rbmq19, SampleConfigurator, port: 1234)
  ...
  test "timeout raises exception" do
    Application.put_env(:rbmq19, SampleConfigurator, host: "example.com", connection_timeout: 50)
  ...
  test "invalid credentials raise exception" do
    Application.put_env(:rbmq19, SampleConfigurator, password: "1234")
  ...
  test "invalid vhost raise exception" do
    Application.put_env(:rbmq19, SampleConfigurator, virtual_host: "somevhost")
